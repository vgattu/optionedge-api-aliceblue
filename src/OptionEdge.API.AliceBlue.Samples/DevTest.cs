...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 1, 5);
        ...
        public void Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(41568, 41569));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(41570, 41571));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(41576, 41577));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(41578, 41579));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(41581, 41583));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(41584, 41585));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(41590, 41593));
                //strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(41603, 41604));
                //strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(41605, 41606));
                //strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(41610, 41611));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(41619, 41620));
                //strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(41621, 41622));
                //strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(41623, 41624));
                //strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(41625, 41626));
                //strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(41627, 41630));
                //strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(41633, 41634));
                //strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(41635, 41636));
                //strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(41638, 41640));
                //strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(41641, 41642));
                //strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(41643, 41644));
                //strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(41645, 41646));
                //strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(41647, 41648));
                //strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(41649, 41650));
                //strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(41654, 41655));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(41656, 41659));
                //strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(41660, 41661));
                //strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(41662, 41667));
                //strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(41668, 41670));
                //strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(41671, 41672));
                //strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(41681, 41684));
                //strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(41692, 41693));
                //strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(41694, 41695));
                //strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(41696, 41699));
                //strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(41700, 41701));
                strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(41707, 41708));
                strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(41709, 41710));
                strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(41711, 41712));
                strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(41722, 41723));
                strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(41724, 41725));
                strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(41729, 41730));
                strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(41731, 41732));
                strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(41738, 41744));
                strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(41746, 41747));
                strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(41753, 41754));
                strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(41756, 41761));
                strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(41762, 41763));
                strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(41766, 41767));
                strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(41775, 41780));
                strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(41781, 41782));
                strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(41783, 41784));
                strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(41790, 41794));
                strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(41797, 41798));
                strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(41800, 41803));
                strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(41807, 41808));
                //strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(41810, 41811));
                //strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(41812, 41815));
                //strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(41816, 41817));
                //strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(41818, 41819));
                //strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(41820, 41821));
                //strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(41829, 41830));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(41836, 41837));
                //strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(41844, 41845));
                //strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(41851, 41856));
                //strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(41857, 41861));
                //strikeInstrumentTokenDict.Add(45400, new Tuple<int, int>(41862, 41863));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(41865, 41866));
                //strikeInstrumentTokenDict.Add(45600, new Tuple<int, int>(41877, 41878));
                //strikeInstrumentTokenDict.Add(45700, new Tuple<int, int>(41889, 41890));
                //strikeInstrumentTokenDict.Add(45800, new Tuple<int, int>(41898, 41901));
                //strikeInstrumentTokenDict.Add(45900, new Tuple<int, int>(41902, 41903));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(41915, 41918));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(41942, 41943));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(41956, 41957));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(41968, 41970));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(41971, 41972));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(41975, 41976));
                //strikeInstrumentTokenDict.Add(49000, new Tuple<int, int>(41981, 41982));

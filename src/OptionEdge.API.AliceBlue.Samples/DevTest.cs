...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 5, 18);
        ...
        public async Task Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(36000, new Tuple<int, int>(45730, 45731));
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(45732, 45733));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(45734, 45735));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(45754, 45755));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(45764, 45765));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(45774, 45776));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(45789, 45790));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(45799, 45800));
                //strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(45801, 45802));
                //strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(45804, 45805));
                //strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(45806, 45807));
                //strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(45808, 45809));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(45810, 45811));
                //strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(45812, 45813));
                //strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(45814, 45815));
                //strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(45816, 45817));
                //strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(45818, 45819));
                //strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(45820, 45821));
                //strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(45822, 45823));
                //strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(45824, 45825));
                //strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(45826, 45827));
                //strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(45828, 45829));
                //strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(45830, 45831));
                //strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(45832, 45833));
                //strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(45834, 45835));
                //strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(45836, 45837));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(45838, 45839));
                //strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(45840, 45841));
                //strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(45842, 45843));
                //strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(45844, 45845));
                //strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(45848, 45849));
                //strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(45850, 45851));
                //strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(45854, 45855));
                //strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(45860, 45861));
                //strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(45862, 45863));
                //strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(45864, 45867));
                //strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(45868, 45869));
                //strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(45870, 45871));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(45872, 45875));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(45876, 45877));
                strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(45878, 45879));
                strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(45880, 45881));
                strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(45882, 45883));
                strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(45884, 45885));
                strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(45886, 45887));
                strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(45888, 45889));
                strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(45890, 45891));
                strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(45892, 45893));
                strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(45894, 45895));
                strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(45896, 45897));
                strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(45898, 45899));
                strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(45900, 45901));
                strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(45902, 45903));
                strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(45904, 45905));
                strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(45906, 45907));
                strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(45908, 45909));
                strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(45910, 45911));
                strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(45912, 45913));
                strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(45914, 45915));
                strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(45916, 45917));
                strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(45918, 45919));
                //strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(45920, 45921));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(45922, 45923));
                //strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(45924, 45925));
                //strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(45926, 45927));
                //strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(45928, 45929));
                //strikeInstrumentTokenDict.Add(45400, new Tuple<int, int>(45932, 45933));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(45934, 45935));
                //strikeInstrumentTokenDict.Add(45600, new Tuple<int, int>(45936, 45937));
                //strikeInstrumentTokenDict.Add(45700, new Tuple<int, int>(45938, 45939));
                //strikeInstrumentTokenDict.Add(45800, new Tuple<int, int>(45940, 45941));
                //strikeInstrumentTokenDict.Add(45900, new Tuple<int, int>(45942, 45943));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(45946, 45949));
                //strikeInstrumentTokenDict.Add(46100, new Tuple<int, int>(45950, 45951));
                //strikeInstrumentTokenDict.Add(46200, new Tuple<int, int>(45952, 45953));
                //strikeInstrumentTokenDict.Add(46300, new Tuple<int, int>(45954, 45955));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(45958, 45959));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(45972, 45973));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(45980, 45981));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(45982, 45985));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(45986, 45987));
                //strikeInstrumentTokenDict.Add(49000, new Tuple<int, int>(45990, 45993));
                //strikeInstrumentTokenDict.Add(49500, new Tuple<int, int>(45994, 45995));
                //strikeInstrumentTokenDict.Add(50000, new Tuple<int, int>(45996, 45997));

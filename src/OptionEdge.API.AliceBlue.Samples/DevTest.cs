...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 6, 8);
        ...
        public async Task Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(44366, 44367));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(44380, 44381));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(44388, 44391));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(44395, 44396));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(44418, 44419));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(44438, 44439));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(44460, 44461));
                //strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(44464, 44465));
                //strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(44473, 44475));
                //strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(44484, 44485));
                //strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(44486, 44487));
                //strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(44500, 44501));
                //strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(44509, 44510));
                //strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(44511, 44512));
                //strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(44513, 44515));
                //strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(44522, 44523));
                //strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(44524, 44525));
                //strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(44531, 44533));
                //strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(44534, 44536));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(44538, 44540));
                //strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(44550, 44551));
                //strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(44552, 44553));
                //strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(44554, 44557));
                //strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(44565, 44566));
                //strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(44567, 44568));
                //strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(44569, 44570));
                //strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(44574, 44575));
                //strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(44579, 44581));
                //strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(44582, 44583));
                //strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(44585, 44590));
                //strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(44592, 44595));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(44600, 44603));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(44604, 44605));
                //strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(44611, 44612));
                //strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(44620, 44622));
                strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(44623, 44624));
                strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(44626, 44627));
                strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(44631, 44632));
                strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(44640, 44644));
                strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(44645, 44646));
                strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(44647, 44648));
                strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(44649, 44650));
                strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(44651, 44654));
                strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(44662, 44663));
                strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(44672, 44673));
                strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(44677, 44678));
                strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(44695, 44696));
                strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(44701, 44702));
                strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(44705, 44706));
                strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(44708, 44709));
                strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(44713, 44714));
                strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(44719, 44720));
                strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(44721, 44722));
                strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(44723, 44724));
                strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(44727, 44728));
                strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(44730, 44731));
                //strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(44741, 44742));
                //strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(44752, 44753));
                //strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(44755, 44756));
                //strikeInstrumentTokenDict.Add(45400, new Tuple<int, int>(44758, 44759));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(44764, 44768));
                //strikeInstrumentTokenDict.Add(45600, new Tuple<int, int>(44778, 44785));
                //strikeInstrumentTokenDict.Add(45700, new Tuple<int, int>(44798, 44801));
                //strikeInstrumentTokenDict.Add(45800, new Tuple<int, int>(44803, 44804));
                //strikeInstrumentTokenDict.Add(45900, new Tuple<int, int>(44819, 44820));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(44823, 44826));
                //strikeInstrumentTokenDict.Add(46100, new Tuple<int, int>(44827, 44830));
                //strikeInstrumentTokenDict.Add(46200, new Tuple<int, int>(44831, 44832));
                //strikeInstrumentTokenDict.Add(46300, new Tuple<int, int>(44833, 44834));
                //strikeInstrumentTokenDict.Add(46400, new Tuple<int, int>(44837, 44838));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(44839, 44840));
                //strikeInstrumentTokenDict.Add(46600, new Tuple<int, int>(44841, 44842));
                //strikeInstrumentTokenDict.Add(46700, new Tuple<int, int>(44843, 44844));
                //strikeInstrumentTokenDict.Add(46800, new Tuple<int, int>(44845, 44846));
                //strikeInstrumentTokenDict.Add(46900, new Tuple<int, int>(44847, 44850));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(44851, 44855));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(44884, 44885));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(44894, 44895));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(44905, 44906));
                //strikeInstrumentTokenDict.Add(49000, new Tuple<int, int>(44935, 44936));
                //strikeInstrumentTokenDict.Add(49500, new Tuple<int, int>(44937, 44938));
                //strikeInstrumentTokenDict.Add(50000, new Tuple<int, int>(44939, 44940));
                //strikeInstrumentTokenDict.Add(50500, new Tuple<int, int>(44941, 44942));

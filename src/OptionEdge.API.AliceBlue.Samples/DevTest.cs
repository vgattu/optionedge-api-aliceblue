...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2022, 12, 1);
        ...
        public void Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(30000, new Tuple<int, int>(35004, 35005));
                //strikeInstrumentTokenDict.Add(30500, new Tuple<int, int>(35016, 35017));
                //strikeInstrumentTokenDict.Add(31000, new Tuple<int, int>(35245, 35246));
                //strikeInstrumentTokenDict.Add(31500, new Tuple<int, int>(35247, 35248));
                //strikeInstrumentTokenDict.Add(32000, new Tuple<int, int>(35408, 35409));
                //strikeInstrumentTokenDict.Add(33000, new Tuple<int, int>(37839, 38272));
                //strikeInstrumentTokenDict.Add(34000, new Tuple<int, int>(38414, 38415));
                //strikeInstrumentTokenDict.Add(35000, new Tuple<int, int>(39109, 39110));
                //strikeInstrumentTokenDict.Add(35500, new Tuple<int, int>(40683, 40686));
                //strikeInstrumentTokenDict.Add(36000, new Tuple<int, int>(40687, 40697));
                //strikeInstrumentTokenDict.Add(36100, new Tuple<int, int>(41070, 41071));
                //strikeInstrumentTokenDict.Add(36300, new Tuple<int, int>(42875, 42876));
                //strikeInstrumentTokenDict.Add(36400, new Tuple<int, int>(42884, 42885));
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(42959, 42961));
                //strikeInstrumentTokenDict.Add(36600, new Tuple<int, int>(42963, 42964));
                //strikeInstrumentTokenDict.Add(36700, new Tuple<int, int>(43024, 43025));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(45445, 45446));
                //strikeInstrumentTokenDict.Add(37200, new Tuple<int, int>(45458, 45463));
                //strikeInstrumentTokenDict.Add(37300, new Tuple<int, int>(45464, 45468));
                //strikeInstrumentTokenDict.Add(37400, new Tuple<int, int>(46187, 46188));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(46189, 46190));
                //strikeInstrumentTokenDict.Add(37700, new Tuple<int, int>(46196, 46198));
                //strikeInstrumentTokenDict.Add(37800, new Tuple<int, int>(46203, 46206));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(50345, 50346));
                //strikeInstrumentTokenDict.Add(38100, new Tuple<int, int>(50347, 50351));
                //strikeInstrumentTokenDict.Add(38200, new Tuple<int, int>(50352, 50353));
                //strikeInstrumentTokenDict.Add(38300, new Tuple<int, int>(50354, 50359));
                //strikeInstrumentTokenDict.Add(38400, new Tuple<int, int>(50364, 50365));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(50367, 50368));
                //strikeInstrumentTokenDict.Add(38600, new Tuple<int, int>(50369, 50370));
                //strikeInstrumentTokenDict.Add(38700, new Tuple<int, int>(50371, 50372));
                //strikeInstrumentTokenDict.Add(38800, new Tuple<int, int>(50373, 50374));
                //strikeInstrumentTokenDict.Add(38900, new Tuple<int, int>(50375, 50376));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(50377, 50380));
                //strikeInstrumentTokenDict.Add(39100, new Tuple<int, int>(50381, 50382));
                //strikeInstrumentTokenDict.Add(39200, new Tuple<int, int>(50383, 50384));
                //strikeInstrumentTokenDict.Add(39300, new Tuple<int, int>(50385, 50386));
                //strikeInstrumentTokenDict.Add(39400, new Tuple<int, int>(50387, 50390));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(50391, 50399));
                //strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(50401, 50402));
                //strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(50403, 50404));
                //strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(50405, 50407));
                //strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(50408, 50409));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(50413, 50414));
                //strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(50418, 50419));
                //strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(50420, 50421));
                //strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(50423, 50424));
                //strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(50425, 50429));
                //strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(50431, 50451));
                //strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(50452, 50453));
                //strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(50454, 50455));
                //strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(50456, 50457));
                //strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(50458, 50463));
                //strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(50479, 50480));
                //strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(50481, 50482));
                //strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(50483, 50484));
                //strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(50485, 50487));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(50490, 50502));
                strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(50503, 50506));
                strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(50507, 50508));
                strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(50509, 50518));
                strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(50519, 50527));
                strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(50536, 50541));
                strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(50542, 50563));
                strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(50564, 50571));
                strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(50576, 50577));
                strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(50578, 50579));
                strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(50585, 50586));
                strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(50588, 50589));
                strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(50590, 50591));
                strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(50592, 50593));
                strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(50594, 50601));
                strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(50606, 50613));
                strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(50614, 50620));
                strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(50621, 50633));
                strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(50634, 50646));
                strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(50652, 50655));
                strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(50656, 50657));
                strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(50662, 50663));
                strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(50664, 50670));
                strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(50671, 50672));
                strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(50673, 50674));
                strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(50675, 50677));
                strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(50692, 50693));
                strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(50696, 50697));
                strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(35249, 35250));
                strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(35269, 35273));
                strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(35320, 35321));
                strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(50700, 50701));
                //strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(35352, 35354));
                //strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(35358, 35361));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(50702, 50703));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(50704, 50705));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(50706, 50716));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(50717, 50720));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(50721, 50732));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(50733, 50749));

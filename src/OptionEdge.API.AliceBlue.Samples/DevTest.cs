...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 3, 9);
        ...
        public async Task Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(35000, new Tuple<int, int>(45605, 45606));
                //strikeInstrumentTokenDict.Add(35500, new Tuple<int, int>(45607, 45608));
                //strikeInstrumentTokenDict.Add(36000, new Tuple<int, int>(45609, 45610));
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(45614, 45615));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(45633, 45634));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(45657, 45658));
                //strikeInstrumentTokenDict.Add(37900, new Tuple<int, int>(45703, 45705));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(45711, 45712));
                //strikeInstrumentTokenDict.Add(38100, new Tuple<int, int>(45713, 45716));
                //strikeInstrumentTokenDict.Add(38200, new Tuple<int, int>(45719, 45720));
                //strikeInstrumentTokenDict.Add(38300, new Tuple<int, int>(45721, 45724));
                //strikeInstrumentTokenDict.Add(38400, new Tuple<int, int>(45729, 45732));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(45736, 45737));
                //strikeInstrumentTokenDict.Add(38600, new Tuple<int, int>(45738, 45743));
                //strikeInstrumentTokenDict.Add(38700, new Tuple<int, int>(45746, 45747));
                //strikeInstrumentTokenDict.Add(38800, new Tuple<int, int>(45750, 45751));
                //strikeInstrumentTokenDict.Add(38900, new Tuple<int, int>(45752, 45753));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(45757, 45761));
                //strikeInstrumentTokenDict.Add(39100, new Tuple<int, int>(45774, 45775));
                //strikeInstrumentTokenDict.Add(39200, new Tuple<int, int>(45778, 45779));
                //strikeInstrumentTokenDict.Add(39300, new Tuple<int, int>(45787, 45788));
                strikeInstrumentTokenDict.Add(39400, new Tuple<int, int>(45803, 45804));
                strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(45805, 45806));
                strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(45816, 45817));
                strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(45819, 45820));
                strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(45827, 45828));
                strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(45838, 45839));
                strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(45844, 45845));
                strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(45864, 45867));
                strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(45871, 45872));
                strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(45878, 45879));
                strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(45890, 45891));
                strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(45900, 45901));
                strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(45912, 45913));
                strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(45928, 45929));
                strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(45930, 45931));
                strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(45944, 45945));
                strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(45947, 45948));
                strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(45960, 45961));
                strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(45962, 45963));
                strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(45974, 45975));
                strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(45976, 45979));
                //strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(45983, 45984));
                //strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(45991, 45992));
                //strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(46001, 46002));
                //strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(46009, 46010));
                //strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(46017, 46021));
                //strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(46022, 46023));
                //strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(46024, 46025));
                //strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(46045, 46046));
                //strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(46053, 46054));
                //strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(46059, 46060));
                //strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(46061, 46062));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(46063, 46064));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(46074, 46075));
                //strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(46086, 46089));
                //strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(46096, 46097));
                //strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(46103, 46108));
                //strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(46152, 46158));
                //strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(46159, 46160));
                //strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(46183, 46184));
                //strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(46196, 46198));
                //strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(46200, 46201));
                //strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(46223, 46226));
                //strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(46238, 46239));
                //strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(46280, 46281));
                //strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(46363, 46365));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(46404, 46405));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(46415, 46416));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(46535, 46536));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(46537, 46539));

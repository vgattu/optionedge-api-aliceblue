...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2022, 11, 24);
        ...
        public void Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(29000, new Tuple<int, int>(54560, 57289));
                //strikeInstrumentTokenDict.Add(29500, new Tuple<int, int>(57290, 57291));
                //strikeInstrumentTokenDict.Add(30000, new Tuple<int, int>(57292, 57293));
                //strikeInstrumentTokenDict.Add(30500, new Tuple<int, int>(57294, 57295));
                //strikeInstrumentTokenDict.Add(31000, new Tuple<int, int>(57296, 59178));
                //strikeInstrumentTokenDict.Add(31500, new Tuple<int, int>(59179, 59200));
                //strikeInstrumentTokenDict.Add(32000, new Tuple<int, int>(59201, 60441));
                //strikeInstrumentTokenDict.Add(32500, new Tuple<int, int>(60442, 60443));
                //strikeInstrumentTokenDict.Add(33000, new Tuple<int, int>(60444, 60445));
                //strikeInstrumentTokenDict.Add(33500, new Tuple<int, int>(60446, 60447));
                //strikeInstrumentTokenDict.Add(34000, new Tuple<int, int>(60448, 60449));
                //strikeInstrumentTokenDict.Add(34500, new Tuple<int, int>(60450, 60451));
                //strikeInstrumentTokenDict.Add(35000, new Tuple<int, int>(60452, 60453));
                //strikeInstrumentTokenDict.Add(35100, new Tuple<int, int>(60454, 60455));
                //strikeInstrumentTokenDict.Add(35200, new Tuple<int, int>(60456, 60457));
                //strikeInstrumentTokenDict.Add(35300, new Tuple<int, int>(60458, 60459));
                //strikeInstrumentTokenDict.Add(35400, new Tuple<int, int>(60460, 60461));
                //strikeInstrumentTokenDict.Add(35500, new Tuple<int, int>(60462, 60463));
                //strikeInstrumentTokenDict.Add(35600, new Tuple<int, int>(60464, 60466));
                //strikeInstrumentTokenDict.Add(35700, new Tuple<int, int>(60467, 60468));
                //strikeInstrumentTokenDict.Add(35800, new Tuple<int, int>(60469, 60470));
                //strikeInstrumentTokenDict.Add(35900, new Tuple<int, int>(60471, 60472));
                //strikeInstrumentTokenDict.Add(36000, new Tuple<int, int>(60473, 60476));
                //strikeInstrumentTokenDict.Add(36100, new Tuple<int, int>(60477, 60478));
                //strikeInstrumentTokenDict.Add(36200, new Tuple<int, int>(60479, 60482));
                //strikeInstrumentTokenDict.Add(36300, new Tuple<int, int>(60483, 60484));
                //strikeInstrumentTokenDict.Add(36400, new Tuple<int, int>(60485, 60486));
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(60487, 60488));
                //strikeInstrumentTokenDict.Add(36600, new Tuple<int, int>(60491, 60492));
                //strikeInstrumentTokenDict.Add(36700, new Tuple<int, int>(60493, 60494));
                //strikeInstrumentTokenDict.Add(36800, new Tuple<int, int>(60495, 60496));
                //strikeInstrumentTokenDict.Add(36900, new Tuple<int, int>(60497, 60503));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(60504, 60506));
                //strikeInstrumentTokenDict.Add(37100, new Tuple<int, int>(60507, 60508));
                //strikeInstrumentTokenDict.Add(37200, new Tuple<int, int>(60509, 60513));
                //strikeInstrumentTokenDict.Add(37300, new Tuple<int, int>(60516, 60517));
                //strikeInstrumentTokenDict.Add(37400, new Tuple<int, int>(60518, 60526));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(60528, 60548));
                //strikeInstrumentTokenDict.Add(37600, new Tuple<int, int>(60549, 60550));
                //strikeInstrumentTokenDict.Add(37700, new Tuple<int, int>(60553, 60554));
                //strikeInstrumentTokenDict.Add(37800, new Tuple<int, int>(60555, 60557));
                //strikeInstrumentTokenDict.Add(37900, new Tuple<int, int>(60558, 60559));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(60560, 60561));
                //strikeInstrumentTokenDict.Add(38100, new Tuple<int, int>(60566, 60567));
                //strikeInstrumentTokenDict.Add(38200, new Tuple<int, int>(60568, 60573));
                //strikeInstrumentTokenDict.Add(38300, new Tuple<int, int>(60574, 60605));
                //strikeInstrumentTokenDict.Add(38400, new Tuple<int, int>(60606, 60607));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(60608, 60609));
                //strikeInstrumentTokenDict.Add(38600, new Tuple<int, int>(60610, 60611));
                //strikeInstrumentTokenDict.Add(38700, new Tuple<int, int>(60612, 60613));
                //strikeInstrumentTokenDict.Add(38800, new Tuple<int, int>(60614, 60615));
                //strikeInstrumentTokenDict.Add(38900, new Tuple<int, int>(60616, 60617));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(60632, 60633));
                //strikeInstrumentTokenDict.Add(39100, new Tuple<int, int>(60635, 60636));
                //strikeInstrumentTokenDict.Add(39200, new Tuple<int, int>(60639, 60640));
                //strikeInstrumentTokenDict.Add(39300, new Tuple<int, int>(60641, 60642));
                //strikeInstrumentTokenDict.Add(39400, new Tuple<int, int>(60647, 60648));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(60649, 60650));
                //strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(60651, 60652));
                //strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(60653, 60654));
                //strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(60659, 60660));
                //strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(60661, 60662));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(60663, 60664));
                //strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(60668, 60669));
                //strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(60675, 60676));
                //strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(60691, 60692));
                //strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(60693, 60694));
                strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(60695, 60696));
                strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(60697, 60698));
                strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(60699, 60700));
                strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(60701, 60702));
                strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(60710, 60711));
                strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(60712, 60713));
                strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(60714, 60715));
                strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(60716, 60719));
                strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(60720, 60721));
                strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(60729, 60730));
                strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(60731, 60732));
                strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(60733, 60734));
                strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(60743, 60744));
                strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(60745, 60746));
                strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(60747, 60748));
                strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(60752, 60760));
                strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(60761, 60766));
                strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(60767, 60772));
                strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(60773, 60777));
                strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(60782, 60783));
                strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(60784, 60788));
                strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(60789, 60790));
                strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(60791, 60792));
                strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(60793, 60811));
                strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(60812, 60813));
                strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(60814, 60818));
                strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(38766, 38796));
                strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(38799, 38801));
                strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(38802, 38803));
                strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(38804, 38805));
                strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(60819, 60820));
                //strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(42826, 42827));
                //strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(42828, 42829));
                //strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(42833, 42834));
                //strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(46495, 47540));
                //strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(60839, 60841));
                //strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(47543, 47544));
                //strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(47547, 47548));
                //strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(39015, 39020));
                //strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(39021, 39022));
                //strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(60842, 60847));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(60848, 60859));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(60860, 60867));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(60868, 60871));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(60872, 60877));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(60878, 60879));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(60880, 60899));

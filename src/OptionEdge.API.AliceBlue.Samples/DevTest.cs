...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 8, 24);
        ...
        public async Task Run()
        {
            try
            {
                ...
                //ceBuyClosed = false;
                //peBuyClosed = false;
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(50365, 50367));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(50368, 50369));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(50370, 50371));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(50382, 50383));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(50384, 50385));
                //strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(50390, 50391));
                //strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(50394, 50395));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(50594, 50595));
                //strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(50602, 50603));
                //strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(50604, 50605));
                //strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(50616, 50617));
                //strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(50618, 50619));
                //strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(50624, 50626));
                //strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(50627, 50628));
                //strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(50637, 50638));
                //strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(50640, 50641));
                //strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(50652, 50653));
                //strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(50666, 50667));
                //strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(50680, 50681));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(50686, 50687));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(50694, 50695));
                //strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(50718, 50719));
                //strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(50720, 50721));
                strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(50722, 50723));
                strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(50724, 50725));
                strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(50748, 50749));
                strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(50750, 50751));
                strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(50774, 50775));
                strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(50784, 50785));
                strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(50798, 50799));
                strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(50806, 50807));
                strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(50812, 50813));
                strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(50838, 50839));
                strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(50852, 50853));
                strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(50854, 50855));
                strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(50864, 50865));
                strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(50866, 50867));
                strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(50868, 50869));
                strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(50870, 50871));
                strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(50872, 50873));
                strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(50906, 50907));
                strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(50908, 50909));
                strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(50912, 50917));
                strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(50918, 50919));
                //strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(50920, 50921));
                //strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(50924, 50925));
                //strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(50926, 50927));
                //strikeInstrumentTokenDict.Add(45400, new Tuple<int, int>(50928, 50929));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(50930, 50931));
                //strikeInstrumentTokenDict.Add(45600, new Tuple<int, int>(50932, 50933));
                //strikeInstrumentTokenDict.Add(45700, new Tuple<int, int>(50934, 50935));
                //strikeInstrumentTokenDict.Add(45800, new Tuple<int, int>(50936, 50937));
                //strikeInstrumentTokenDict.Add(45900, new Tuple<int, int>(50938, 50939));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(50941, 50942));
                //strikeInstrumentTokenDict.Add(46100, new Tuple<int, int>(50943, 50944));
                //strikeInstrumentTokenDict.Add(46200, new Tuple<int, int>(50945, 50946));
                //strikeInstrumentTokenDict.Add(46300, new Tuple<int, int>(50947, 50948));
                //strikeInstrumentTokenDict.Add(46400, new Tuple<int, int>(50949, 50950));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(50951, 50952));
                //strikeInstrumentTokenDict.Add(46600, new Tuple<int, int>(50953, 50954));
                //strikeInstrumentTokenDict.Add(46700, new Tuple<int, int>(50955, 50959));
                //strikeInstrumentTokenDict.Add(46800, new Tuple<int, int>(50968, 50974));
                //strikeInstrumentTokenDict.Add(46900, new Tuple<int, int>(50975, 50977));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(50980, 50982));
                //strikeInstrumentTokenDict.Add(47100, new Tuple<int, int>(50983, 50985));
                //strikeInstrumentTokenDict.Add(47200, new Tuple<int, int>(50986, 50987));
                //strikeInstrumentTokenDict.Add(47300, new Tuple<int, int>(50988, 50989));
                //strikeInstrumentTokenDict.Add(47400, new Tuple<int, int>(50990, 50991));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(50992, 50993));
                //strikeInstrumentTokenDict.Add(47600, new Tuple<int, int>(50994, 50995));
                //strikeInstrumentTokenDict.Add(47700, new Tuple<int, int>(50996, 50997));
                //strikeInstrumentTokenDict.Add(47800, new Tuple<int, int>(50998, 50999));
                //strikeInstrumentTokenDict.Add(47900, new Tuple<int, int>(51000, 51001));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(51002, 51003));
                //strikeInstrumentTokenDict.Add(48100, new Tuple<int, int>(51004, 51005));
                //strikeInstrumentTokenDict.Add(48200, new Tuple<int, int>(51006, 51007));
                //strikeInstrumentTokenDict.Add(48300, new Tuple<int, int>(51008, 51009));
                //strikeInstrumentTokenDict.Add(48400, new Tuple<int, int>(51010, 51011));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(51012, 51013));
                //strikeInstrumentTokenDict.Add(48600, new Tuple<int, int>(51014, 51015));
                //strikeInstrumentTokenDict.Add(48700, new Tuple<int, int>(51016, 51017));
                //strikeInstrumentTokenDict.Add(49000, new Tuple<int, int>(51025, 51026));
                //strikeInstrumentTokenDict.Add(49500, new Tuple<int, int>(51035, 51036));
                //strikeInstrumentTokenDict.Add(50000, new Tuple<int, int>(51050, 51051));
                //strikeInstrumentTokenDict.Add(50500, new Tuple<int, int>(61266, 61267));
                //strikeInstrumentTokenDict.Add(51000, new Tuple<int, int>(61278, 61279));
                //strikeInstrumentTokenDict.Add(51500, new Tuple<int, int>(61284, 61285));
                //strikeInstrumentTokenDict.Add(52000, new Tuple<int, int>(61286, 61287));

...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        private static int aliceBlueNumberOfLots1 = 18;
        ...
        public static DateTime expiryDate = new DateTime(2023, 9, 13);
        ...
        public async Task Run()
        {
            try
            {
                ...
                //ceBuyClosed = false;
                ////peBuyClosed = false;
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(40166, 40167));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(43550, 44207));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(44208, 44209));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(44210, 44211));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(44402, 44403));
                //strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(44412, 44413));
                //strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(44424, 44425));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(44432, 44433));
                //strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(44434, 44435));
                //strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(44436, 44437));
                //strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(44438, 44439));
                //strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(44444, 44445));
                //strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(44446, 44447));
                //strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(44448, 44449));
                //strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(44452, 44453));
                //strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(44454, 44455));
                //strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(44456, 44457));
                //strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(44458, 44459));
                //strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(44460, 44461));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(44462, 44463));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(44464, 44465));
                //strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(44466, 44467));
                //strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(44472, 44473));
                //strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(44474, 44475));
                //strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(44476, 44477));
                //strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(44478, 44479));
                //strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(44480, 44481));
                //strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(44482, 44483));
                //strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(44484, 44485));
                //strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(44486, 44487));
                //strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(44488, 44489));
                //strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(44490, 44491));
                strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(44492, 44493));
                strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(44494, 44495));
                strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(44496, 44497));
                strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(44498, 44499));
                strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(44500, 44501));
                strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(44506, 44507));
                strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(44508, 44509));
                strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(44510, 44511));
                strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(44512, 44513));
                strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(44514, 44515));
                strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(44516, 44517));
                strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(44518, 44519));
                strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(44520, 44521));
                strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(44522, 44523));
                strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(44524, 44525));
                strikeInstrumentTokenDict.Add(45400, new Tuple<int, int>(44526, 44530));
                strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(44531, 44533));
                strikeInstrumentTokenDict.Add(45600, new Tuple<int, int>(44534, 44536));
                strikeInstrumentTokenDict.Add(45700, new Tuple<int, int>(44537, 44538));
                strikeInstrumentTokenDict.Add(45800, new Tuple<int, int>(44540, 44544));
                strikeInstrumentTokenDict.Add(45900, new Tuple<int, int>(44545, 44549));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(44550, 44551));
                //strikeInstrumentTokenDict.Add(46100, new Tuple<int, int>(44552, 44553));
                //strikeInstrumentTokenDict.Add(46200, new Tuple<int, int>(44554, 44557));
                //strikeInstrumentTokenDict.Add(46300, new Tuple<int, int>(44562, 44563));
                //strikeInstrumentTokenDict.Add(46400, new Tuple<int, int>(44564, 44565));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(44566, 44567));
                //strikeInstrumentTokenDict.Add(46600, new Tuple<int, int>(44568, 44569));
                //strikeInstrumentTokenDict.Add(46700, new Tuple<int, int>(44570, 44571));
                //strikeInstrumentTokenDict.Add(46800, new Tuple<int, int>(44572, 44573));
                //strikeInstrumentTokenDict.Add(46900, new Tuple<int, int>(44574, 44575));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(44576, 44577));
                //strikeInstrumentTokenDict.Add(47100, new Tuple<int, int>(44579, 44581));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(44597, 44598));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(44609, 44610));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(44622, 44623));
                //strikeInstrumentTokenDict.Add(49000, new Tuple<int, int>(44637, 44638));
                //strikeInstrumentTokenDict.Add(49500, new Tuple<int, int>(44649, 44650));
                //strikeInstrumentTokenDict.Add(50000, new Tuple<int, int>(44651, 44654));
                //strikeInstrumentTokenDict.Add(50500, new Tuple<int, int>(44658, 44659));

...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        private static int aliceBlueNumberOfLots1 = 14;
        ...
        public static DateTime expiryDate = new DateTime(2023, 2, 2);
        ...
        public async Task Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(49232, 49233));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(49234, 49235));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(49236, 49237));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(49238, 49239));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(49242, 49243));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(49258, 49259));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(49293, 49294));
                //strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(49295, 49296));
                //strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(49299, 49301));
                //strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(49302, 49305));
                //strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(49306, 49307));
                strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(49308, 49311));
                strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(49312, 49313));
                strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(49314, 49324));
                strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(49326, 49331));
                strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(49332, 49338));
                strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(49339, 49340));
                strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(49341, 49342));
                strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(49343, 49344));
                strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(49345, 49346));
                strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(49347, 49349));
                strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(49350, 49351));
                strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(49352, 49353));
                strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(49354, 49355));
                strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(49356, 49357));
                strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(49359, 49360));
                strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(49361, 49362));
                strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(49363, 49364));
                strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(49365, 49366));
                strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(49367, 49368));
                strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(49382, 49383));
                strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(49384, 49385));
                //strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(49386, 49387));
                //strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(49388, 49389));
                //strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(49390, 49391));
                //strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(49392, 49397));
                //strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(49398, 49399));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(49400, 49401));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(49402, 49403));
                //strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(49406, 49407));
                //strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(49408, 49409));
                //strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(49410, 49411));
                //strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(49412, 49413));
                //strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(49414, 49415));
                //strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(49416, 49417));
                //strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(49418, 49419));
                //strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(49420, 49421));
                //strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(49422, 49423));
                //strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(49426, 49427));
                //strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(49429, 49430));
                //strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(49431, 49434));
                //strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(49435, 49436));
                //strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(49437, 49438));
                //strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(49439, 49440));
                //strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(49441, 49446));
                //strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(49452, 49453));
                //strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(49454, 49455));
                //strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(49456, 49457));
                //strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(49459, 49460));
                //strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(49461, 49462));
                //strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(49463, 49464));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(49465, 49466));
                //strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(49467, 49468));
                //strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(49469, 49471));
                //strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(49474, 49476));
                //strikeInstrumentTokenDict.Add(45400, new Tuple<int, int>(49479, 49480));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(49481, 49482));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(49495, 49497));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(49507, 49508));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(49509, 49510));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(49515, 49519));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(49520, 49521));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(49523, 49524));

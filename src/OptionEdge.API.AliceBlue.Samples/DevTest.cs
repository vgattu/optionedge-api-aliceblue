...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 2, 23);
        ...
        public async Task Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(35500, new Tuple<int, int>(57793, 57794));
                //strikeInstrumentTokenDict.Add(36000, new Tuple<int, int>(57795, 57796));
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(57797, 57798));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(57799, 57800));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(57801, 57802));
                //strikeInstrumentTokenDict.Add(37600, new Tuple<int, int>(53149, 53150));
                //strikeInstrumentTokenDict.Add(37700, new Tuple<int, int>(49884, 49885));
                //strikeInstrumentTokenDict.Add(37800, new Tuple<int, int>(49886, 49887));
                //strikeInstrumentTokenDict.Add(37900, new Tuple<int, int>(49888, 49889));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(57803, 57804));
                //strikeInstrumentTokenDict.Add(38100, new Tuple<int, int>(49890, 49891));
                //strikeInstrumentTokenDict.Add(38200, new Tuple<int, int>(49892, 49893));
                //strikeInstrumentTokenDict.Add(38300, new Tuple<int, int>(49894, 49895));
                //strikeInstrumentTokenDict.Add(38400, new Tuple<int, int>(49572, 49573));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(57805, 57806));
                //strikeInstrumentTokenDict.Add(38600, new Tuple<int, int>(44578, 44579));
                //strikeInstrumentTokenDict.Add(38700, new Tuple<int, int>(44582, 44584));
                //strikeInstrumentTokenDict.Add(38800, new Tuple<int, int>(46129, 46130));
                //strikeInstrumentTokenDict.Add(38900, new Tuple<int, int>(46133, 46134));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(57807, 57808));
                //strikeInstrumentTokenDict.Add(39100, new Tuple<int, int>(57809, 57810));
                //strikeInstrumentTokenDict.Add(39200, new Tuple<int, int>(57811, 57812));
                //strikeInstrumentTokenDict.Add(39300, new Tuple<int, int>(57813, 57814));
                //strikeInstrumentTokenDict.Add(39400, new Tuple<int, int>(57815, 57816));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(57817, 57818));
                //strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(57819, 57820));
                //strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(57821, 57822));
                //strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(57823, 57824));
                //strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(57825, 57826));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(57827, 57828));
                //strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(57829, 57830));
                //strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(57831, 57832));
                //strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(57833, 57834));
                //strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(57835, 57836));
                strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(57837, 57838));
                strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(57839, 57840));
                strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(57841, 57842));
                strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(57843, 57844));
                strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(57845, 57846));
                strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(57847, 57848));
                strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(57849, 57850));
                strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(57851, 57852));
                strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(57853, 57854));
                strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(57855, 57856));
                strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(57857, 57858));
                strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(57859, 57860));
                strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(57861, 57862));
                strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(57863, 57864));
                strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(57865, 57866));
                strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(57867, 57868));
                strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(57869, 57870));
                strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(57871, 57872));
                strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(57873, 57874));
                strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(57875, 57876));
                strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(57877, 57878));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(57879, 57880));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(57881, 57882));
                //strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(57883, 57884));
                //strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(57885, 57886));
                //strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(57887, 57888));
                //strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(57889, 57890));
                //strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(57891, 57892));
                //strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(57893, 57894));
                //strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(57895, 57896));
                //strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(57897, 57898));
                //strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(57899, 57900));
                //strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(57901, 57902));
                //strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(57903, 57906));
                //strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(57907, 57910));
                //strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(57911, 57912));
                //strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(57913, 57915));
                //strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(57916, 57917));
                //strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(57918, 57919));
                //strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(57920, 57923));
                //strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(57924, 57925));
                //strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(57926, 57927));
                //strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(57932, 57933));
                //strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(57934, 57935));
                //strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(57936, 57937));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(57947, 57949));
                //strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(57950, 57951));
                //strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(57952, 57953));
                //strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(57954, 57955));
                //strikeInstrumentTokenDict.Add(45400, new Tuple<int, int>(57956, 57957));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(57964, 57965));
                //strikeInstrumentTokenDict.Add(45600, new Tuple<int, int>(57966, 57967));
                //strikeInstrumentTokenDict.Add(45700, new Tuple<int, int>(57968, 57969));
                //strikeInstrumentTokenDict.Add(45800, new Tuple<int, int>(57976, 57977));
                //strikeInstrumentTokenDict.Add(45900, new Tuple<int, int>(57978, 57979));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(57980, 57981));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(57994, 57998));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(58020, 58023));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(58026, 58027));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(58029, 58030));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(58031, 58032));
                //strikeInstrumentTokenDict.Add(49000, new Tuple<int, int>(58033, 58034));

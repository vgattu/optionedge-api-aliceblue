...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 2, 9);
        ...
        public async Task Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(35500, new Tuple<int, int>(38955, 38956));
                //strikeInstrumentTokenDict.Add(36000, new Tuple<int, int>(38957, 38958));
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(38959, 38960));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(38961, 38962));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(38963, 38964));
                //strikeInstrumentTokenDict.Add(37600, new Tuple<int, int>(53124, 53125));
                //strikeInstrumentTokenDict.Add(37700, new Tuple<int, int>(53126, 53129));
                //strikeInstrumentTokenDict.Add(37800, new Tuple<int, int>(53130, 53131));
                //strikeInstrumentTokenDict.Add(37900, new Tuple<int, int>(53132, 53133));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(38966, 38972));
                //strikeInstrumentTokenDict.Add(38100, new Tuple<int, int>(41129, 41130));
                //strikeInstrumentTokenDict.Add(38200, new Tuple<int, int>(35006, 35007));
                //strikeInstrumentTokenDict.Add(38300, new Tuple<int, int>(35010, 35011));
                //strikeInstrumentTokenDict.Add(38400, new Tuple<int, int>(35016, 35017));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(38973, 38975));
                //strikeInstrumentTokenDict.Add(38600, new Tuple<int, int>(38976, 38979));
                //strikeInstrumentTokenDict.Add(38700, new Tuple<int, int>(38980, 38981));
                //strikeInstrumentTokenDict.Add(38800, new Tuple<int, int>(38982, 38989));
                //strikeInstrumentTokenDict.Add(38900, new Tuple<int, int>(38990, 38993));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(38994, 38995));
                //strikeInstrumentTokenDict.Add(39100, new Tuple<int, int>(39000, 39001));
                //strikeInstrumentTokenDict.Add(39200, new Tuple<int, int>(39003, 39004));
                //strikeInstrumentTokenDict.Add(39300, new Tuple<int, int>(39005, 39006));
                //strikeInstrumentTokenDict.Add(39400, new Tuple<int, int>(39007, 39008));
                strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(39009, 39010));
                strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(39011, 39012));
                strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(39013, 39014));
                strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(39016, 39017));
                strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(39018, 39019));
                strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(39023, 39024));
                strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(39025, 39026));
                strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(39027, 39028));
                strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(39029, 39030));
                strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(39031, 39032));
                strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(39033, 39034));
                strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(39035, 39036));
                strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(39038, 39039));
                strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(39041, 39042));
                strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(39043, 39044));
                strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(39046, 39048));
                strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(39049, 39050));
                strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(39051, 39052));
                strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(39053, 39054));
                strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(39055, 39056));
                strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(39057, 39058));
                strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(39059, 39062));
                strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(39068, 39069));
                strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(39074, 39075));
                strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(39076, 39077));
                strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(39078, 39079));
                //strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(39082, 39084));
                //strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(39086, 39087));
                //strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(39088, 39089));
                //strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(39097, 39098));
                //strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(39099, 39105));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(39115, 39118));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(39119, 39120));
                //strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(39121, 39122));
                //strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(39123, 39124));
                //strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(39125, 39127));
                //strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(39128, 39129));
                //strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(39130, 39137));
                //strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(39144, 39146));
                //strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(39151, 39152));
                //strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(39153, 39154));
                //strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(39159, 39160));
                //strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(39161, 39163));
                //strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(39165, 39166));
                //strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(39167, 39168));
                //strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(39169, 39170));
                //strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(39171, 39172));
                //strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(39173, 39174));
                //strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(39175, 39176));
                //strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(39177, 39178));
                //strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(39179, 39180));
                //strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(39181, 39182));
                //strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(39183, 39184));
                //strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(39187, 39189));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(39192, 39193));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(39206, 39207));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(39227, 39228));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(39242, 39243));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(39250, 39251));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(39252, 39253));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(39254, 39255));

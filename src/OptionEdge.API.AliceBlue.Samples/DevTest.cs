...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 6, 15);
        ...
        public async Task Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(37318, 37319));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(37320, 37321));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(37322, 37323));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(37332, 37333));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(37342, 37343));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(37355, 37358));
                //strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(37367, 37368));
                //strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(37377, 37378));
                //strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(37379, 37382));
                //strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(37383, 37384));
                //strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(37385, 37392));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(37393, 37394));
                //strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(37395, 37396));
                //strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(37398, 37399));
                //strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(37400, 37401));
                //strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(37402, 37403));
                //strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(37404, 37405));
                //strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(37406, 37407));
                //strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(37408, 37411));
                //strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(37412, 37413));
                //strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(37414, 37415));
                //strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(37416, 37417));
                //strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(37418, 37419));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(37422, 37423));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(37424, 37425));
                //strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(37426, 37427));
                //strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(37428, 37429));
                strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(37430, 37431));
                strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(37432, 37433));
                strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(37434, 37437));
                strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(37438, 37439));
                strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(37440, 37441));
                strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(37442, 37443));
                strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(37444, 37445));
                strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(37446, 37447));
                strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(37448, 37450));
                strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(37451, 37456));
                strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(37457, 37458));
                strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(37459, 37464));
                strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(37465, 37466));
                strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(37467, 37468));
                strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(37469, 37470));
                strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(37471, 37472));
                strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(37473, 37474));
                strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(37475, 37477));
                strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(37478, 37480));
                strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(37481, 37482));
                strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(37483, 37484));
                //strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(37485, 37486));
                //strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(37487, 37497));
                //strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(37500, 37501));
                //strikeInstrumentTokenDict.Add(45400, new Tuple<int, int>(37502, 37503));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(37504, 37505));
                //strikeInstrumentTokenDict.Add(45600, new Tuple<int, int>(37506, 37507));
                //strikeInstrumentTokenDict.Add(45700, new Tuple<int, int>(37508, 37509));
                //strikeInstrumentTokenDict.Add(45800, new Tuple<int, int>(37510, 37511));
                //strikeInstrumentTokenDict.Add(45900, new Tuple<int, int>(37512, 37513));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(37514, 37515));
                //strikeInstrumentTokenDict.Add(46100, new Tuple<int, int>(37516, 37517));
                //strikeInstrumentTokenDict.Add(46200, new Tuple<int, int>(37518, 37521));
                //strikeInstrumentTokenDict.Add(46300, new Tuple<int, int>(37522, 37523));
                //strikeInstrumentTokenDict.Add(46400, new Tuple<int, int>(37524, 37525));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(37526, 37527));
                //strikeInstrumentTokenDict.Add(46600, new Tuple<int, int>(37528, 37529));
                //strikeInstrumentTokenDict.Add(46700, new Tuple<int, int>(37530, 37531));
                //strikeInstrumentTokenDict.Add(46800, new Tuple<int, int>(37532, 37533));
                //strikeInstrumentTokenDict.Add(46900, new Tuple<int, int>(37535, 37536));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(37538, 37539));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(37558, 37559));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(37572, 37573));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(37584, 37588));
                //strikeInstrumentTokenDict.Add(49000, new Tuple<int, int>(37589, 37590));
                //strikeInstrumentTokenDict.Add(49500, new Tuple<int, int>(37591, 37597));
                //strikeInstrumentTokenDict.Add(50000, new Tuple<int, int>(37598, 37599));
                //strikeInstrumentTokenDict.Add(50500, new Tuple<int, int>(37600, 37601));

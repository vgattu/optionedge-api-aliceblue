...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 1, 12);
        ...
        public void Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(40536, 40543));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(40544, 40549));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(40551, 40554));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(40569, 40574));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(40575, 40576));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(40579, 40580));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(40581, 40587));
                //strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(40597, 40604));
                //strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(40616, 40618));
                //strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(40621, 40624));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(40625, 40626));
                //strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(40629, 40631));
                //strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(40635, 40636));
                //strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(40637, 40643));
                //strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(40644, 40645));
                //strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(40648, 40649));
                //strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(40650, 40651));
                //strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(40661, 40662));
                //strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(40669, 40670));
                //strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(40671, 40674));
                //strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(40675, 40676));
                //strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(40677, 40678));
                //strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(40679, 40690));
                //strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(40691, 40692));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(40693, 40694));
                strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(40698, 40699));
                strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(40700, 40701));
                strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(40703, 40706));
                strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(40707, 40708));
                strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(40710, 40711));
                strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(40712, 40713));
                strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(40714, 40715));
                strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(40718, 40719));
                strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(40720, 40721));
                strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(40722, 40723));
                strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(40724, 40725));
                strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(40727, 40728));
                strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(40729, 40731));
                strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(40732, 40733));
                strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(40734, 40735));
                strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(40736, 40737));
                strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(40738, 40739));
                strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(40740, 40741));
                strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(40743, 40744));
                strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(40745, 40746));
                strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(40747, 40751));
                //strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(40752, 40754));
                //strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(40755, 40756));
                //strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(40757, 40758));
                //strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(40759, 40760));
                //strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(40762, 40765));
                //strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(40766, 40767));
                //strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(40768, 40769));
                //strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(40770, 40771));
                //strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(40772, 40773));
                //strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(40774, 40775));
                //strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(40776, 40779));
                //strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(40780, 40782));
                //strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(40784, 40785));
                //strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(40786, 40789));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(40790, 40791));
                //strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(40793, 40794));
                //strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(40796, 40797));
                //strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(40798, 40799));
                //strikeInstrumentTokenDict.Add(45400, new Tuple<int, int>(40800, 40802));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(40803, 40806));
                //strikeInstrumentTokenDict.Add(45600, new Tuple<int, int>(40810, 40818));
                //strikeInstrumentTokenDict.Add(45700, new Tuple<int, int>(40819, 40820));
                //strikeInstrumentTokenDict.Add(45800, new Tuple<int, int>(40821, 40822));
                //strikeInstrumentTokenDict.Add(45900, new Tuple<int, int>(40823, 40824));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(40825, 40826));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(40836, 40837));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(40846, 40847));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(40862, 40863));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(40869, 40874));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(40885, 40886));
                //strikeInstrumentTokenDict.Add(49000, new Tuple<int, int>(40891, 40895));

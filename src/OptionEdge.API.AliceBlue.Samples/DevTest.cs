...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 2, 16);
        ...
        public async Task Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(35500, new Tuple<int, int>(43493, 43503));
                //strikeInstrumentTokenDict.Add(36000, new Tuple<int, int>(43504, 43505));
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(43508, 43509));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(43510, 43516));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(43517, 43519));
                //strikeInstrumentTokenDict.Add(37600, new Tuple<int, int>(53136, 53139));
                //strikeInstrumentTokenDict.Add(37700, new Tuple<int, int>(53140, 53141));
                //strikeInstrumentTokenDict.Add(37800, new Tuple<int, int>(53142, 53143));
                //strikeInstrumentTokenDict.Add(37900, new Tuple<int, int>(53144, 53145));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(43520, 43533));
                //strikeInstrumentTokenDict.Add(38100, new Tuple<int, int>(43534, 43543));
                //strikeInstrumentTokenDict.Add(38200, new Tuple<int, int>(43544, 43545));
                //strikeInstrumentTokenDict.Add(38300, new Tuple<int, int>(43546, 43547));
                //strikeInstrumentTokenDict.Add(38400, new Tuple<int, int>(43548, 43549));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(43550, 43554));
                //strikeInstrumentTokenDict.Add(38600, new Tuple<int, int>(43557, 43558));
                //strikeInstrumentTokenDict.Add(38700, new Tuple<int, int>(43559, 43560));
                //strikeInstrumentTokenDict.Add(38800, new Tuple<int, int>(43561, 43562));
                //strikeInstrumentTokenDict.Add(38900, new Tuple<int, int>(43563, 43569));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(43570, 43571));
                //strikeInstrumentTokenDict.Add(39100, new Tuple<int, int>(43575, 43576));
                //strikeInstrumentTokenDict.Add(39200, new Tuple<int, int>(43577, 43582));
                //strikeInstrumentTokenDict.Add(39300, new Tuple<int, int>(43583, 43586));
                //strikeInstrumentTokenDict.Add(39400, new Tuple<int, int>(43587, 43590));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(43592, 43594));
                //strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(43595, 43596));
                //strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(43597, 43598));
                //strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(43599, 43600));
                //strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(43601, 43602));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(43603, 43605));
                //strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(43606, 43607));
                //strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(43608, 43623));
                //strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(43624, 43627));
                //strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(43628, 43631));
                strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(43633, 43634));
                strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(43635, 43636));
                strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(43637, 43639));
                strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(43640, 43641));
                strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(43642, 43643));
                strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(43644, 43651));
                strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(43655, 43656));
                strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(43657, 43658));
                strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(43659, 43667));
                strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(43668, 43672));
                strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(43674, 43678));
                strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(43679, 43682));
                strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(43683, 43684));
                strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(43685, 43686));
                strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(43687, 43688));
                strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(43689, 43690));
                strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(43691, 43693));
                strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(43694, 43695));
                strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(43696, 43699));
                strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(43700, 43701));
                strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(43702, 43705));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(43706, 43712));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(43713, 43714));
                //strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(43715, 43716));
                //strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(43717, 43721));
                //strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(43725, 43726));
                //strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(43727, 43728));
                //strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(43729, 43730));
                //strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(43731, 43732));
                //strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(43734, 43735));
                //strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(43736, 43737));
                //strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(43738, 43739));
                //strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(43742, 43743));
                //strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(43744, 43745));
                //strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(43746, 43747));
                //strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(43749, 43750));
                //strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(43751, 43752));
                //strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(43753, 43754));
                //strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(43758, 43762));
                //strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(43763, 43764));
                //strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(43765, 43766));
                //strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(43767, 43768));
                //strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(43769, 43771));
                //strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(43772, 43774));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(43777, 43798));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(43819, 43820));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(43834, 43835));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(43841, 43845));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(43846, 43847));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(43848, 43858));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(43859, 43861));

...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2023, 3, 2);
        ...
        public async Task Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(35000, new Tuple<int, int>(48560, 48561));
                //strikeInstrumentTokenDict.Add(35500, new Tuple<int, int>(48562, 48563));
                //strikeInstrumentTokenDict.Add(36000, new Tuple<int, int>(48564, 48565));
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(48566, 48567));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(48568, 48569));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(48571, 48573));
                //strikeInstrumentTokenDict.Add(37600, new Tuple<int, int>(53158, 53159));
                //strikeInstrumentTokenDict.Add(37700, new Tuple<int, int>(53160, 53165));
                //strikeInstrumentTokenDict.Add(37800, new Tuple<int, int>(53166, 53167));
                //strikeInstrumentTokenDict.Add(37900, new Tuple<int, int>(53168, 53170));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(48574, 48575));
                //strikeInstrumentTokenDict.Add(38100, new Tuple<int, int>(53171, 53172));
                //strikeInstrumentTokenDict.Add(38200, new Tuple<int, int>(53173, 53174));
                //strikeInstrumentTokenDict.Add(38300, new Tuple<int, int>(48576, 48585));
                //strikeInstrumentTokenDict.Add(38400, new Tuple<int, int>(48586, 48594));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(48595, 48604));
                //strikeInstrumentTokenDict.Add(38600, new Tuple<int, int>(48605, 48612));
                //strikeInstrumentTokenDict.Add(38700, new Tuple<int, int>(48615, 48616));
                //strikeInstrumentTokenDict.Add(38800, new Tuple<int, int>(48617, 48618));
                //strikeInstrumentTokenDict.Add(38900, new Tuple<int, int>(48624, 48627));
                strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(48628, 48629));
                strikeInstrumentTokenDict.Add(39100, new Tuple<int, int>(48630, 48637));
                strikeInstrumentTokenDict.Add(39200, new Tuple<int, int>(48642, 48645));
                strikeInstrumentTokenDict.Add(39300, new Tuple<int, int>(48648, 48654));
                strikeInstrumentTokenDict.Add(39400, new Tuple<int, int>(48655, 48657));
                strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(48658, 48669));
                strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(48670, 48673));
                strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(48677, 48679));
                strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(48680, 48681));
                strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(48682, 48683));
                strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(48685, 48686));
                strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(48687, 48695));
                strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(48696, 48698));
                strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(48699, 48702));
                strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(48703, 48704));
                strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(48705, 48706));
                strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(48708, 48709));
                strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(48710, 48711));
                strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(48712, 48713));
                strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(48714, 48715));
                strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(48716, 48717));
                //strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(48722, 48726));
                //strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(48728, 48731));
                //strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(48732, 48733));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(48736, 48737));
                //strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(48739, 48744));
                //strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(48745, 48752));
                //strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(48753, 48760));
                //strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(48765, 48775));
                //strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(48778, 48779));
                //strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(48780, 48784));
                //strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(48785, 48786));
                //strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(48787, 48790));
                //strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(48794, 48799));
                //strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(48858, 48859));
                //strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(48874, 48875));
                //strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(48883, 48884));
                //strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(48888, 48889));
                //strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(48890, 48893));
                //strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(48899, 48900));
                //strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(48907, 48909));
                //strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(48914, 48915));
                //strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(48916, 48917));
                //strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(48920, 48921));
                //strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(48922, 48939));
                //strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(48940, 48947));
                //strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(48948, 48953));
                //strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(48954, 48955));
                //strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(48956, 48962));
                //strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(48963, 48964));
                //strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(48965, 48966));
                //strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(48967, 48971));
                //strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(48972, 48973));
                //strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(48974, 48975));
                //strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(48976, 48979));
                //strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(48980, 48981));
                //strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(48982, 48983));
                //strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(48991, 48992));
                //strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(48993, 49009));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(49016, 49021));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(49038, 49042));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(49081, 49082));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(49114, 49115));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(49133, 49135));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(49138, 49141));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(49145, 49159));

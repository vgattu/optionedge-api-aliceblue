...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2022, 12, 15);
        ...
        public void Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(45235, 45236));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(45237, 45238));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(45239, 45240));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(45276, 45278));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(45326, 45329));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(45346, 45359));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(45398, 45399));
                //strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(45400, 45407));
                //strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(45408, 45410));
                //strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(45411, 45434));
                //strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(45435, 45436));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(45437, 45441));
                //strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(45448, 45451));
                //strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(45452, 45453));
                //strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(45454, 45459));
                //strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(45460, 45465));
                //strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(45466, 45467));
                //strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(45471, 45473));
                //strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(45474, 45494));
                //strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(45495, 45500));
                //strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(45503, 45538));
                //strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(45539, 45543));
                //strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(45544, 45545));
                //strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(45546, 45551));
                //strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(45552, 45557));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(45564, 45565));
                //strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(45571, 45578));
                //strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(45582, 45588));
                //strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(45589, 45593));
                //strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(45596, 45632));
                //strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(45633, 45634));
                strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(45635, 45636));
                strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(45637, 45639));
                strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(45642, 45643));
                strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(45644, 45645));
                strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(45646, 45647));
                strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(45652, 45654));
                strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(45655, 45681));
                strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(45682, 45683));
                strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(45684, 45685));
                strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(45686, 45687));
                strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(45701, 45713));
                strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(45714, 45715));
                strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(45722, 45723));
                strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(45739, 45740));
                strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(45748, 45749));
                strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(45750, 45751));
                strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(45752, 45753));
                strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(45754, 45755));
                strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(45756, 45758));
                strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(45759, 45762));
                strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(45764, 45765));
                strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(45770, 45771));
                strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(45772, 45773));
                strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(45774, 45775));
                strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(45776, 45777));
                strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(45778, 45779));
                strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(45780, 45781));
                strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(45782, 45783));
                strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(45784, 46106));
                strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(46107, 47553));
                strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(47554, 47555));
                //strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(47556, 48129));
                //strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(48133, 48171));
                //strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(48172, 48403));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(48412, 48413));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(48418, 48422));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(48423, 48424));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(48427, 48429));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(48430, 48431));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(48432, 48434));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(48435, 48438));

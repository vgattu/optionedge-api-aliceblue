...
namespace OptionEdge.API.AliceBlue.Samples
{
    public class DevTest
    {
        ...
        public static DateTime expiryDate = new DateTime(2022, 12, 29);
        ...
        public void Run()
        {
            try
            {
                //strikeInstrumentTokenDict.Add(27000, new Tuple<int, int>(58369, 58370));
                //strikeInstrumentTokenDict.Add(28500, new Tuple<int, int>(58374, 58375));
                //strikeInstrumentTokenDict.Add(30000, new Tuple<int, int>(58386, 58387));
                //strikeInstrumentTokenDict.Add(31500, new Tuple<int, int>(58388, 58389));
                //strikeInstrumentTokenDict.Add(32500, new Tuple<int, int>(85188, 85189));
                //strikeInstrumentTokenDict.Add(33000, new Tuple<int, int>(58390, 58394));
                //strikeInstrumentTokenDict.Add(33500, new Tuple<int, int>(85190, 85191));
                //strikeInstrumentTokenDict.Add(34000, new Tuple<int, int>(85200, 85201));
                //strikeInstrumentTokenDict.Add(34500, new Tuple<int, int>(58395, 58396));
                //strikeInstrumentTokenDict.Add(35000, new Tuple<int, int>(85291, 85292));
                //strikeInstrumentTokenDict.Add(35500, new Tuple<int, int>(85353, 85354));
                //strikeInstrumentTokenDict.Add(35600, new Tuple<int, int>(85355, 85356));
                //strikeInstrumentTokenDict.Add(35700, new Tuple<int, int>(85357, 85359));
                //strikeInstrumentTokenDict.Add(35800, new Tuple<int, int>(85360, 85361));
                //strikeInstrumentTokenDict.Add(35900, new Tuple<int, int>(85362, 85363));
                //strikeInstrumentTokenDict.Add(36000, new Tuple<int, int>(58401, 58402));
                //strikeInstrumentTokenDict.Add(36100, new Tuple<int, int>(85364, 85365));
                //strikeInstrumentTokenDict.Add(36200, new Tuple<int, int>(85366, 85367));
                //strikeInstrumentTokenDict.Add(36300, new Tuple<int, int>(85368, 85369));
                //strikeInstrumentTokenDict.Add(36400, new Tuple<int, int>(85370, 85371));
                //strikeInstrumentTokenDict.Add(36500, new Tuple<int, int>(85372, 85373));
                //strikeInstrumentTokenDict.Add(36600, new Tuple<int, int>(85374, 85375));
                //strikeInstrumentTokenDict.Add(36700, new Tuple<int, int>(85376, 85377));
                //strikeInstrumentTokenDict.Add(36800, new Tuple<int, int>(85378, 85379));
                //strikeInstrumentTokenDict.Add(36900, new Tuple<int, int>(85380, 85381));
                //strikeInstrumentTokenDict.Add(37000, new Tuple<int, int>(85382, 85383));
                //strikeInstrumentTokenDict.Add(37100, new Tuple<int, int>(85384, 85385));
                //strikeInstrumentTokenDict.Add(37200, new Tuple<int, int>(85386, 85387));
                //strikeInstrumentTokenDict.Add(37300, new Tuple<int, int>(85388, 85389));
                //strikeInstrumentTokenDict.Add(37400, new Tuple<int, int>(85390, 85391));
                //strikeInstrumentTokenDict.Add(37500, new Tuple<int, int>(58403, 58404));
                //strikeInstrumentTokenDict.Add(37600, new Tuple<int, int>(85392, 85393));
                //strikeInstrumentTokenDict.Add(37700, new Tuple<int, int>(85394, 85395));
                //strikeInstrumentTokenDict.Add(37800, new Tuple<int, int>(85396, 85397));
                //strikeInstrumentTokenDict.Add(37900, new Tuple<int, int>(85398, 85399));
                //strikeInstrumentTokenDict.Add(38000, new Tuple<int, int>(85400, 85401));
                //strikeInstrumentTokenDict.Add(38100, new Tuple<int, int>(85402, 85403));
                //strikeInstrumentTokenDict.Add(38200, new Tuple<int, int>(85404, 85405));
                //strikeInstrumentTokenDict.Add(38300, new Tuple<int, int>(85406, 85407));
                //strikeInstrumentTokenDict.Add(38400, new Tuple<int, int>(85422, 85423));
                //strikeInstrumentTokenDict.Add(38500, new Tuple<int, int>(85424, 85425));
                //strikeInstrumentTokenDict.Add(38600, new Tuple<int, int>(85426, 85429));
                //strikeInstrumentTokenDict.Add(38700, new Tuple<int, int>(85430, 85434));
                //strikeInstrumentTokenDict.Add(38800, new Tuple<int, int>(85435, 85493));
                //strikeInstrumentTokenDict.Add(38900, new Tuple<int, int>(85494, 85495));
                //strikeInstrumentTokenDict.Add(39000, new Tuple<int, int>(58407, 58409));
                //strikeInstrumentTokenDict.Add(39100, new Tuple<int, int>(85496, 85497));
                //strikeInstrumentTokenDict.Add(39200, new Tuple<int, int>(85498, 85512));
                //strikeInstrumentTokenDict.Add(39300, new Tuple<int, int>(85513, 85536));
                //strikeInstrumentTokenDict.Add(39400, new Tuple<int, int>(85537, 85538));
                //strikeInstrumentTokenDict.Add(39500, new Tuple<int, int>(85539, 85542));
                //strikeInstrumentTokenDict.Add(39600, new Tuple<int, int>(85543, 85544));
                //strikeInstrumentTokenDict.Add(39700, new Tuple<int, int>(85545, 85548));
                //strikeInstrumentTokenDict.Add(39800, new Tuple<int, int>(85549, 85550));
                //strikeInstrumentTokenDict.Add(39900, new Tuple<int, int>(85551, 85598));
                //strikeInstrumentTokenDict.Add(40000, new Tuple<int, int>(85599, 85607));
                //strikeInstrumentTokenDict.Add(40100, new Tuple<int, int>(85608, 85609));
                //strikeInstrumentTokenDict.Add(40200, new Tuple<int, int>(85610, 85730));
                //strikeInstrumentTokenDict.Add(40300, new Tuple<int, int>(85731, 85766));
                //strikeInstrumentTokenDict.Add(40400, new Tuple<int, int>(85778, 85779));
                //strikeInstrumentTokenDict.Add(40500, new Tuple<int, int>(58410, 58419));
                //strikeInstrumentTokenDict.Add(40600, new Tuple<int, int>(85926, 85927));
                //strikeInstrumentTokenDict.Add(40700, new Tuple<int, int>(85928, 85929));
                //strikeInstrumentTokenDict.Add(40800, new Tuple<int, int>(85935, 85936));
                //strikeInstrumentTokenDict.Add(40900, new Tuple<int, int>(85937, 85938));
                //strikeInstrumentTokenDict.Add(41000, new Tuple<int, int>(85939, 85940));
                //strikeInstrumentTokenDict.Add(41100, new Tuple<int, int>(85941, 85942));
                //strikeInstrumentTokenDict.Add(41200, new Tuple<int, int>(85943, 85944));
                //strikeInstrumentTokenDict.Add(41300, new Tuple<int, int>(85945, 85946));
                //strikeInstrumentTokenDict.Add(41400, new Tuple<int, int>(85947, 85948));
                strikeInstrumentTokenDict.Add(41500, new Tuple<int, int>(85949, 85950));
                strikeInstrumentTokenDict.Add(41600, new Tuple<int, int>(85951, 85952));
                strikeInstrumentTokenDict.Add(41700, new Tuple<int, int>(35022, 35023));
                strikeInstrumentTokenDict.Add(41800, new Tuple<int, int>(35027, 35031));
                strikeInstrumentTokenDict.Add(41900, new Tuple<int, int>(35032, 35037));
                strikeInstrumentTokenDict.Add(42000, new Tuple<int, int>(58420, 58421));
                strikeInstrumentTokenDict.Add(42100, new Tuple<int, int>(35038, 35060));
                strikeInstrumentTokenDict.Add(42200, new Tuple<int, int>(35061, 35068));
                strikeInstrumentTokenDict.Add(42300, new Tuple<int, int>(35069, 35072));
                strikeInstrumentTokenDict.Add(42400, new Tuple<int, int>(35073, 35074));
                strikeInstrumentTokenDict.Add(42500, new Tuple<int, int>(85953, 85954));
                strikeInstrumentTokenDict.Add(42600, new Tuple<int, int>(35075, 35103));
                strikeInstrumentTokenDict.Add(42700, new Tuple<int, int>(36876, 36877));
                strikeInstrumentTokenDict.Add(42800, new Tuple<int, int>(36878, 36948));
                strikeInstrumentTokenDict.Add(42900, new Tuple<int, int>(36951, 36954));
                strikeInstrumentTokenDict.Add(43000, new Tuple<int, int>(85955, 85956));
                strikeInstrumentTokenDict.Add(43100, new Tuple<int, int>(36955, 36960));
                strikeInstrumentTokenDict.Add(43200, new Tuple<int, int>(42549, 42550));
                strikeInstrumentTokenDict.Add(43300, new Tuple<int, int>(42551, 42554));
                strikeInstrumentTokenDict.Add(43400, new Tuple<int, int>(40363, 40365));
                strikeInstrumentTokenDict.Add(43500, new Tuple<int, int>(35106, 35107));
                //strikeInstrumentTokenDict.Add(43600, new Tuple<int, int>(40366, 40368));
                //strikeInstrumentTokenDict.Add(43700, new Tuple<int, int>(40369, 40374));
                //strikeInstrumentTokenDict.Add(43800, new Tuple<int, int>(40375, 40376));
                //strikeInstrumentTokenDict.Add(43900, new Tuple<int, int>(40377, 40381));
                //strikeInstrumentTokenDict.Add(44000, new Tuple<int, int>(85957, 85958));
                //strikeInstrumentTokenDict.Add(44100, new Tuple<int, int>(48086, 48087));
                //strikeInstrumentTokenDict.Add(44200, new Tuple<int, int>(48088, 48089));
                //strikeInstrumentTokenDict.Add(44300, new Tuple<int, int>(48090, 48091));
                //strikeInstrumentTokenDict.Add(44400, new Tuple<int, int>(36142, 36151));
                //strikeInstrumentTokenDict.Add(44500, new Tuple<int, int>(85959, 85960));
                //strikeInstrumentTokenDict.Add(44600, new Tuple<int, int>(36208, 36213));
                //strikeInstrumentTokenDict.Add(44700, new Tuple<int, int>(36220, 36221));
                //strikeInstrumentTokenDict.Add(44800, new Tuple<int, int>(36570, 36577));
                //strikeInstrumentTokenDict.Add(44900, new Tuple<int, int>(53273, 53274));
                //strikeInstrumentTokenDict.Add(45000, new Tuple<int, int>(39759, 39762));
                //strikeInstrumentTokenDict.Add(45100, new Tuple<int, int>(53275, 53276));
                //strikeInstrumentTokenDict.Add(45200, new Tuple<int, int>(53283, 53284));
                //strikeInstrumentTokenDict.Add(45300, new Tuple<int, int>(53285, 53286));
                //strikeInstrumentTokenDict.Add(45400, new Tuple<int, int>(46030, 46034));
                //strikeInstrumentTokenDict.Add(45500, new Tuple<int, int>(85961, 85962));
                //strikeInstrumentTokenDict.Add(45600, new Tuple<int, int>(46051, 46052));
                //strikeInstrumentTokenDict.Add(45700, new Tuple<int, int>(46057, 46058));
                //strikeInstrumentTokenDict.Add(45800, new Tuple<int, int>(42427, 42439));
                //strikeInstrumentTokenDict.Add(45900, new Tuple<int, int>(35234, 35235));
                //strikeInstrumentTokenDict.Add(46000, new Tuple<int, int>(85963, 85964));
                //strikeInstrumentTokenDict.Add(46500, new Tuple<int, int>(44830, 44831));
                //strikeInstrumentTokenDict.Add(47000, new Tuple<int, int>(85965, 85966));
                //strikeInstrumentTokenDict.Add(47500, new Tuple<int, int>(85967, 85968));
                //strikeInstrumentTokenDict.Add(48000, new Tuple<int, int>(56300, 56301));
                //strikeInstrumentTokenDict.Add(48500, new Tuple<int, int>(35104, 35115));
                //strikeInstrumentTokenDict.Add(49000, new Tuple<int, int>(36961, 39487));
                //strikeInstrumentTokenDict.Add(49500, new Tuple<int, int>(37684, 37685));
